...
def test_main_success_path(
    mock_load_config, mock_github, mock_blogs, mock_arxiv,
    mock_load_history, mock_update_history,
    mock_render_html, mock_render_md, mock_llm, mock_send_email
):
    cfg = _base_mocks()
    cfg["email"].update({"smtp_user": "u", "smtp_pass": "p"})
    mock_load_config.return_value = cfg
    mock_github.return_value = [{"name": "r", "url": "http://a.com"}]
    ...
    mock_llm.return_value = [{"source": "X", "title": "T", "title_cn": "中文标题", "summary_cn": "中文摘要", "url": "http://b.com"}]
